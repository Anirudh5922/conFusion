...
class Header extends Component {
    ...
    handleSignin(event) {
           this.toggleModal2();
            this.props.SigninUser({firstname:this.firstname.value,lastname:this.lastname.value,username: this.username.value, password: this.password.value});
            event.preventDefault();
    }
        ...
        return(
            <React.Fragment>
                ...
                <Modal isOpen={this.state.isModal2Open} toggle={this.toggleModal2}>
                    <ModalHeader toggle={this.toggleModal2}>Sign in</ModalHeader>
                    <ModalBody>
